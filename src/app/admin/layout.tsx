    ...
    return (
      <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4 text-white">
        <div className="max-w-md w-full bg-slate-900 border border-slate-800 rounded-3xl p-8 text-center space-y-6 shadow-2xl">
          ...
          <Link
            href="/"
            className="inline-flex items-center justify-center gap-2 text-xs font-extrabold uppercase px-6 h-12 bg-[#FF3B30] hover:bg-[#D92D20] text-white rounded-2xl w-full transition-all shadow-lg shadow-red-500/20"
          >
