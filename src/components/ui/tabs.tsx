...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center justify-center rounded-xl bg-surface-2 p-1 text-muted border border-border",
      className
    )}
    {...props}
  />
